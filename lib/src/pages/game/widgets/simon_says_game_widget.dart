// lib/pages/game/widgets/simon_says_game_widget.dart
import 'dart:math';
...
class SimonSaysGameWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<SimonSaysGameProvider>(
  ...
  Widget _buildGrid(
    ...
    List<int> listData,
    SimonSaysGameProvider provider,
  ) {
            ...
            child: InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color:
                      provider.simonStep == index ? Colors.yellow : Colors.grey,
                  borderRadius: BorderRadius.circular(10.r),
                ),
                child: Center(
                  child: Text(
