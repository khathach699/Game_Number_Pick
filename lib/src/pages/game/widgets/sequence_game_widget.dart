// lib/pages/game/widgets/sequence_game_widget.dart
import 'dart:math';
...
class SequenceGameWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<SequenceGameProvider>(
