// lib/pages/game/widgets/countdown_game_widget.dart
import 'dart:math';
...
class CountdownGameWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<CountdownGameProvider>(
  ...
  Widget _buildGrid(
    ...
    List<int> listData,
    CountdownGameProvider provider,
  ) {
